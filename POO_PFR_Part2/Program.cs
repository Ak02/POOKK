            ...
            while (ligne != null)
            {
                try
                {
                    ...
                    if (tmp[0] == "Sorcier")
                    {
                        ...
                        personnelS.Add(new Sorcier(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe),tmp[4]), tmp[5], (Sorcier.Grade)Enum.Parse(typeof(Sorcier.Grade), tmp[6]), pv));
                   
                        Console.WriteLine("ajouter un sorcier");
                    }

                    if(tmp[0] == "Monstre") // pb affectation + param
                    {
                        personnelS.Add(new Monstre(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe),tmp[4]), tmp[5], int.Parse(tmp[6]), null ));
                        Console.WriteLine("ajouter un monstre");
                    }
                    if (tmp[0] == "Demon")// pb affectation + param
                    {
                        personnelS.Add(new Demon(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe),tmp[4]), tmp[5], int.Parse(tmp[6]), null, int.Parse(tmp[8])) );
                        Console.WriteLine("ajouter un demon");
                    }
                    if (tmp[0] == "Fantome")// pb affectation + param
                    {
                        personnelS.Add(new Fantome(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe),tmp[4]), tmp[5], int.Parse(tmp[6]), null  ));
                        Console.WriteLine("ajouter un fantome");
                    }
                    if (tmp[0] == "LoupGarou")
                    {
                        personnelS.Add(new LoupGarou(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe), tmp[4]), tmp[5], int.Parse(tmp[6]), null, double.Parse(tmp[8])) );
                        Console.WriteLine("ajouter un LoupGarou");
                    }
                    if (tmp[0] == "Vampire")
                    {
                        personnelS.Add(new Vampire(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe),tmp[4]), tmp[5], int.Parse(tmp[6]), null, float.Parse(tmp[8])) );
                        Console.WriteLine("ajouter un Vampire");
                    }
                    if (tmp[0] == "Zombie")
                    {
                        personnelS.Add(new Zombie(int.Parse(tmp[1]), tmp[2], tmp[3], (Personnel.TypeSexe)Enum.Parse(typeof(Personnel.TypeSexe), tmp[4]), tmp[5], int.Parse(tmp[6]), null, (Zombie.CouleurZ)Enum.Parse(typeof(Zombie.CouleurZ),tmp[8]),int.Parse(tmp[9]) ));
                        Console.WriteLine("ajouter un Zombie");
                    }
                    if (tmp[0] == "Boutique")
                    {
                        attractionS.Add(new Boutique(int.Parse(tmp[1]), tmp[2], int.Parse(tmp[3]), bool.Parse(tmp[4]),tmp[5], (Boutique.typeBoutique)Enum.Parse(typeof(Boutique.typeBoutique), tmp[6]) ));
